...
$message['name'] = filter_var($_POST['inputName'], FILTER_SANITIZE_STRING);
if(empty($message['name'])){
    $output['success'] = false;
    $output['messages'][] = 'missing name key';
}

$message['email'] = filter_var($_POST['inputEmail'], FILTER_VALIDATE_EMAIL);
if(empty($message['email'])){
    $output['success'] = false;
    $output['messages'][] = 'invalid email key';
}

$message['subject'] = filter_var($_POST['inputSubject'], FILTER_SANITIZE_STRING);
// if(empty($message['subject'])){
//     $output['success'] = false;
//     $output['messages'][] = 'invalid subject key';
// }

$message['message'] = filter_var($_POST['inputMessage'], FILTER_SANITIZE_STRING);
